...
function nameWithS() {
  // your code goes here
  return got.houses.reduce((acc, house) => {
    acc = acc.concat(house.people.map((p) => p.name).filter((name) => name.toLowerCase().include("s")
    ));
    return acc;
  }, []);
}
...
function nameWithA() {
  // your code goes here
  return got.houses.reduce((acc, house) => {
    acc = acc.concat(house.people.map((p) => p.name).filter((name) => name.toLowerCase().include("a")
    ));
    return acc;
  }, []);
}
